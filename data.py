...
window_train_gen_online = window_generator(TRAIN_DIRS, N_WINDOW_TRAIN, WINDOW_BATCH_SIZE)
window_val_gen_online = window_generator(VAL_DIRS, N_WINDOW_VAL, WINDOW_BATCH_SIZE)
